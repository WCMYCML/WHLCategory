...
// Decomposing dates
@property (readonly) NSInteger whl_nearestHour;
@property (readonly) NSInteger whl_hour;
@property (readonly) NSInteger whl_minute;
@property (readonly) NSInteger whl_seconds;
@property (readonly) NSInteger whl_day;
@property (readonly) NSInteger whl_month;
@property (readonly) NSInteger whl_year;
@property (readonly) NSInteger whl_weekContainInMonth;
@property (readonly) NSInteger whl_weekContainInYear;
@property (readonly) NSInteger whl_weekday;
@property (readonly) NSInteger whl_nthWeekday; // e.g. 2nd Tuesday of the month == 2
...
/// 根据自定义时间文字，转换时间戳为日期字符串
/// - Parameters:
///   - dateFormatterStr: 时间字符串格式
///   - utcTime: 时间戳
